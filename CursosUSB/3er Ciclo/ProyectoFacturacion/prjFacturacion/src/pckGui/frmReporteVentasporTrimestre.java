 ...
 * @author HOME
 */
public class frmReporteVentasporTrimestre extends javax.swing.JFrame {
    ...
    void listarVenta(){
        ...
        }tblVentasporTrimestre.setModel(mod);lblFilas.setText("Filas Encontradas: "+tblVentasporTrimestre.getRowCount());
    }
     void listarAño(){
    ...
    void listarVentaporTrimestre(int tri,int año){
        DefaultTableModel mod=new DefaultTableModel();
        String columnas[]={
            "Codigo","Tipo Documento","Fecha","Hora","Empleado","Cliente"
        };mod.setColumnIdentifiers(columnas);
        
        ArrayList<Venta> lista=oVentaDao.ventasporTrimestreAño(tri, año);
        for (Venta oventa : lista) {
            Object data[]={
              oventa.getIdVenta(),oventa.getTipoDocumento(),oventa.getFecha(),oventa.getHora(),oventa.getEmpleado(),oventa.getNombrecliente()
            };mod.addRow(data);
    ...
    void cargarItemComboBox(int cant){
        cboTrimestre.removeAllItems();
        for (int i = 0; i <= cant; i++) {
            if(i==0){
                cboTrimestre.addItem("--Todos--");
            }else if (i>0){
                cboTrimestre.addItem(i);
            }
        }
    }
    /**
     * Creates new form frmReporteVentasporTrimestre
     */
    public frmReporteVentasporTrimestre() {
        initComponents();
        listarVenta();
        cargarItemComboBox(4);
        listarAño();
    }
    ...
    private void initComponents() {
        ...
        tblVentasporTrimestre = new javax.swing.JTable();
        ...
        tblVentasporTrimestre.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblVentasporTrimestre.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblVentasporTrimestreMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblVentasporTrimestre);
        ...
        cboTrimestre.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--Todos--" }));
        ...
        pnlCuadroBusquedaLayout.setHorizontalGroup(
            ...
            .addGroup(pnlCuadroBusquedaLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cboTrimestre, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        listarVenta();
        cboTrimestre.setSelectedIndex(0);
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        int tri=cboTrimestre.getSelectedIndex();
        if(cboAño.getSelectedIndex()==0 || tri==0){
            
        }else {
        listarVentaporTrimestre(tri,año);
        }
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
       ...
       int año=Integer.parseInt(""+cboAño.getSelectedItem());
        ...
        if(tri==0 || cboAño.getSelectedIndex()==0){
            JOptionPane.showMessageDialog(this, "Seleccione un trimestre");
        }else {
            report.startReporteVentasTrimestre(tri, año);
        }
        
        
    }//GEN-LAST:event_btnGenerarReporteActionPerformed

    private void tblVentasporTrimestreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVentasporTrimestreMouseClicked
        // TODO add your handling code here:
           int pos=tblVentasporTrimestre.getSelectedRow();
        int idVenta=Integer.parseInt( ""+tblVentasporTrimestre.getValueAt(pos, 0));
    ...
    }//GEN-LAST:event_tblVentasporTrimestreMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteVentasporTrimestre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReporteVentasporTrimestre().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblVentasporTrimestre;
